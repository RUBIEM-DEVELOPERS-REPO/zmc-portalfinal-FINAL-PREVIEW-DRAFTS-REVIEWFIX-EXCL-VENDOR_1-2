...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Insert a few key countries to avoid conflicts
        DB::table('countries')->insert([
            ...
            ['name' => 'Kazakhstan', 'code' => 'KZ', 'phone_code' => '+77'],
            ...
            ['name' => 'Russia', 'code' => 'RU', 'phone_code' => '+78'],
            ...
            ['name' => 'United States', 'code' => 'US', 'phone_code' => '+11'],
