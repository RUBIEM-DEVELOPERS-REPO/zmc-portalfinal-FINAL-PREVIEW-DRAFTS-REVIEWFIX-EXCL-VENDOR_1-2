    ...
    <div class="form-steps-container">
      ...
      <div class="step-content active" id="confirmSection">
        ...
        <div class="row g-3 mb-4">
          <div class="col-md-6">
            <form method="POST" action="{{ route('mediahouse.renewals.confirm-no-changes', $renewal) }}">
              @csrf
      ...
      <div class="step-content" id="changesFormContainer" style="display:none;">
        ...
        <form method="POST" action="{{ route('mediahouse.renewals.submit-changes', $renewal) }}" enctype="multipart/form-data">
          @csrf
