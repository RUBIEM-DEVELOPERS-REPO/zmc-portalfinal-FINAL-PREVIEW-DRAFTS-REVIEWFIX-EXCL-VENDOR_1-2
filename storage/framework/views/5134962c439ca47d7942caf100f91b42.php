...
<div class="zmc-dashboard-wrapper" style="font-family:'Roboto', sans-serif; color:#334155;">
      ...
      <div class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <select name="category" class="form-select">
            ...
            <?php if(request('application_type') === 'accreditation'): ?>
  ...
  <div id="card_fields" class="card shadow-sm mb-4" style="display: none;">
    ...
    <div class="card-body">
      ...
      <?php if(request('application_type') === 'registration'): ?>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/patiencemupikeni/Downloads/ZMCPORTAL/resources/views/staff/officer/physical_intake_enhanced.blade.php ENDPATH**/ ?>