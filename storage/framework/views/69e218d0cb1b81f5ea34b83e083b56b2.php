<div class="row g-3 mb-4">
    <div class="col-12 col-md-4">
      <div class="zmc-card shadow-sm border-0 p-3 h-100 bg-white rounded-4">
        ...
        <div class="fw-bold fs-3" style="color: #0f172a;"><?php echo e(number_format($kpis['total_applications'] ?? 0)); ?></div>
      </div>
    </div>
    ...
    <div class="col-12 col-md-4">
      <div class="zmc-card shadow-sm border-0 p-3 h-100 bg-white rounded-4 border-start border-4 border-primary">
        ...
        <div class="fw-bold fs-3 text-primary"><?php echo e(number_format($kpis['pending_applications'] ?? 0)); ?></div>
      </div>
    </div>
    ...
    <div class="col-12 col-md-4">
      <div class="zmc-card shadow-sm border-0 p-3 h-100 bg-white rounded-4 border-start border-4 border-warning">
        ...
        <div class="fw-bold fs-3 text-warning"><?php echo e(number_format($kpis['rejected_applications'] ?? 0)); ?></div>
      </div>
    </div>
</div>
<?php /**PATH /Users/patiencemupikeni/Downloads/ZMCPORTAL/resources/views/partials/analytics/accreditation_summary.blade.php ENDPATH**/ ?>