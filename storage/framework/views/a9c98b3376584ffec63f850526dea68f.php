      ...
      <table class="table table-hover align-middle mb-0 zmc-mini-table">
        <thead>
          <tr>
            ...
            <th style="font-size: 0.75rem;"><i class="ri-flag-line me-1"></i> New or Renewal</th>
            <th style="font-size: 0.75rem;"><i class="ri-global-line me-1"></i> Foreign or Local</th>
          </tr>
        </thead>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          ...
          <tr>
            ...
            <td>
              <span class="badge rounded-pill bg-<?php echo e($newOrRenewal === 'Renewal' ? 'info' : ($newOrRenewal === 'Replacement' ? 'warning' : 'primary')); ?> px-3" style="font-size: 0.7rem;"><?php echo e($newOrRenewal); ?></span>
            </td>
            <td>
              <span class="badge rounded-pill bg-<?php echo e($foreignOrLocal === 'Foreign' ? 'warning' : 'success'); ?> px-3" style="font-size: 0.7rem;"><?php echo e($foreignOrLocal); ?></span>
            </td>
          </tr>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/patiencemupikeni/Downloads/zmc-portalfinal-FINAL-PREVIEW-DRAFTS-REVIEWFIX-EXCL-VENDOR_1-2/resources/views/staff/officer/dashboard.blade.php ENDPATH**/ ?>